module Spree
  module AppConfigurationSpreeItemReturnsDecorator
    ...
    def self.prepended(base)
      ...
      puts "Spree::AppConfigurationSpreeItemReturnsDecorator.self.prepended(base) :: B2 #{base}"
      puts "Spree::AppConfigurationSpreeItemReturnsDecorator.self.prepended(base) :: B3 #{self}"
      puts "Spree::AppConfigurationSpreeItemReturnsDecorator.self.prepended(base) :: B4 #{self.has_preference?('return_initiation_admin_mail_address')}"
      puts "Spree::AppConfigurationSpreeItemReturnsDecorator.self.prepended(base) :: B5 #{self.has_preference?(:return_initiation_admin_mail_address)}"
      puts "Spree::AppConfigurationSpreeItemReturnsDecorator.self.prepended(base) :: B6 #{base.has_preference?('return_initiation_admin_mail_address')}"
      puts "Spree::AppConfigurationSpreeItemReturnsDecorator.self.prepended(base) :: B7 #{base.has_preference?(:return_initiation_admin_mail_address)}"
